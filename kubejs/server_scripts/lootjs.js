LootJS.modifiers(event => {
    ...
    event.addEntityLootModifier('minecraft:warden')
        .addWeightedLoot([1, 3], [
            Item.of('minecraft:echo_shard').withChance(30),
            Item.of('minecraft:sculk').withChance(50)
        ])
    //末影龙掉落龙肉
    event.addEntityLootModifier('minecraft:ender_dragon')
        .addWeightedLoot([1, 8], [
            Item.of('ends_delight:raw_dragon_meat').withChance(30),
            Item.of('ends_delight:dragon_leg').withChance(20),
            Item.of('ends_delight:dragon_tooth').withChance(20)
        ])
    //凋零不掉落凋零之眼，增加未激活的凋零之眼掉落
    event.addEntityLootModifier('minecraft:wither')
        .replaceLoot('endrem:wither_eye', 'kubejs:unactivated_wither_eye')
    //删除唤魔者掉落的魔力之眼
    event.addEntityLootModifier('minecraft:evoker')
        .removeLoot('endrem:magical_eye')
        //增加概率掉蒙尘的落魔力之眼
        .addWeightedLoot([1, 2], [
            Item.of('kubejs:dusty_magical_eye').withChance(10),
            Item.of('emerald').withChance(100)
        ])
    //删除沙漠神殿掉落的远古之眼
    ...
    event.addLootTableModifier('minecraft:chests/woodland_mansion')
        .replaceLoot('endrem:magical_eye', 'kubejs:dusty_magical_eye')
    //删除掠夺者哨站掉落的腐化之眼
    ...
    event.addLootTableModifier('betterfortresses:chests/keep')
        .addWeightedLoot([1, 2], [
            Item.of('endrem:nether_eye').withChance(1),
            Item.of('nether_brick_wall').withChance(20)
        ])
    //移除原版下界堡垒中的下界之眼的掉落
