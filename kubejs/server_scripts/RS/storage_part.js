ServerEvents.recipes(e => {
    ...
    e.recipes.create.sequenced_assembly("refinedstorage:256k_fluid_storage_part", "#forge:ingots/copper", [
        ...
        .loops(3)
    // 1024K流体存储元件合成
    const iner_1024K = "createdelight:incompleted_1024K_fluid_storage_part"
    e.recipes.create.sequenced_assembly("refinedstorage:1024k_fluid_storage_part", "#forge:ingots/copper", [
        e.recipes.create.deploying(iner_1024K, [iner_1024K, "refinedstorage:improved_processor"]),
        e.recipes.create.deploying(iner_1024K, [iner_1024K, "create:fluid_tank"]),
        e.recipes.create.filling(iner_1024K, [iner_1024K, Fluid.of("water 400")]),
        e.recipes.create.deploying(iner_1024K, [iner_1024K, "refinedstorage:256k_fluid_storage_part"]),
        e.recipes.create.pressing(iner_1024K, iner_1024K)
    ])
        .transitionalItem(iner_1024K)
        .id("refinedstorage:1024k_fluid_storage_part")
        .loops(3)
    // 4096K流体存储元件合成
    const iner_4096K = "createdelight:incompleted_4096K_fluid_storage_part"
    e.recipes.create.sequenced_assembly("refinedstorage:4096k_fluid_storage_part", "#forge:ingots/copper", [
        e.recipes.create.deploying(iner_4096K, [iner_4096K, "refinedstorage:advanced_processor"]),
        e.recipes.create.deploying(iner_4096K, [iner_4096K, "create:fluid_tank"]),
        e.recipes.create.filling(iner_4096K, [iner_4096K, Fluid.of("water 800")]),
        e.recipes.create.deploying(iner_4096K, [iner_4096K, "refinedstorage:1024k_fluid_storage_part"]),
        e.recipes.create.pressing(iner_4096K, iner_4096K)
    ])
        .transitionalItem(iner_4096K)
